 ...
 *
 */
class FUser implements org.hyperledger.fabric.sdk.User, Serializable {
    ...
    /** 存储配置对象 */
    private transient FStore keyValStore;
    private String keyValStoreName;

    public FUser(String name, String org, FStore store) {
        this.name = name;
    ...
    private FUser restoreState() {
        ...
        if (null != memberStr) {
            ...
            try {
                ...
                FUser state = (FUser) ois.readObject();
                if (state != null) {
