...
public class ChaincodeManager {
    ...
    private FOrg fabricOrg;
    private Channel channel;
    private ChaincodeID chaincodeID;

    public ChaincodeManager(FConfig fabricConfig)
    ...
    private FOrg getFabricOrg() throws NoSuchAlgorithmException, NoSuchProviderException, InvalidKeySpecException, IOException {
        ...
        FStore fabricStore = new FStore(storeFile);

        // Get Org1 from configuration
        FOrg fabricOrg = new FOrg(peers, orderers, fabricStore, config.getCryptoConfigPath());
    ...
    private Channel getChannel(FOrg fabricOrg, HFClient client)
            throws NoSuchAlgorithmException, NoSuchProviderException, InvalidKeySpecException, IOException, CryptoException, InvalidArgumentException, TransactionException {
